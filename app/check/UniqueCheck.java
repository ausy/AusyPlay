...
public class UniqueCheck extends AbstractAnnotationCheck<Unique> {
	...
	@Override
	public void configure(final Unique constraintAnnotation) {
	...
	private String[] getPropertyNames(final String uniqueKey) {
		String completeUniqueKey;
		if (this.uniqueKeyContext.length() > 0) {
			completeUniqueKey = this.uniqueKeyContext + ";" + uniqueKey;
		} else {
